...
public class EmpregadoRest {
    ...
    public Response listarEmpregadosAtivos() throws Exception {
        try {
            ...
            return Response.status(Status.INTERNAL_SERVER_ERROR)
                    .entity("{ \"mensagem\" : \"Falha ao listar empregados ativos!\" , \"detalhe\" :  \""+ e.getMessage() +"\"  }").build();
        }
    }
    ...
    public Response listarEmpregadosInativos() throws Exception {
        try {
            ...
            return Response.status(Status.INTERNAL_SERVER_ERROR)
                    .entity("{ \"mensagem\" : \"Falha ao listar empregados inativos!\" , \"detalhe\" :  \""+ e.getMessage() +"\"  }").build();
        }
    }
